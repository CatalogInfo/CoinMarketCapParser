...
export default class BinanceParse extends ExchangeParser {
  ...
  async getBaseQuoteAssets(): Promise<SymbolBaseQuote[]> {
    ...
    ExchangeMapper.convertSymbolBaseToTradingSymbols(this.tradingSymbols, BinanceMapper.convertAssetsToSymbolQouteBase(tradingPairs, this.requiredQuoteAssets));
